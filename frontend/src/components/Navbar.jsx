        ...
        <div className='flex item-center justify-between text-sm py-4 mb-5 border-b-gray-400'>
            ...
            <ul className='hidden md:flex items:start gap-5 font-medium'>
                ...
                <NavLink to='/doctors'>
                    ...
                    <hr className='border-none ouline-none h-0.5 bg-primary w-3/5 m-auto hidden active' />
                </NavLink>
                <NavLink to='/about'>
            ...
            <div className='flex items-center gap-4'>
                    ...
                    token && userData ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                        ...
                        <div className="absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block">
                            <div className="min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4">
                                ...
                                {/* why is the logout fun not called  */}
                ...
                <div className={` ${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`}>
                    <div className='flex items-center justify-between px-5 py-6'>
                        ...
                        <img className='w-7' onClick={() => setShowMenu(false)} src={assets.cross_icon} alt="" /></div>
