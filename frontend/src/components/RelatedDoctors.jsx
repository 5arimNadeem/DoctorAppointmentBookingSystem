...
const RelatedDoctors = ({ speciality, docId }) => {
    ...
    const { doctors, assets } = useContext(DoctorContext)
    ...
    return (
        <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
            ...
            <button
                ...
                className='bg-blue-300 text-gray-600 px-12 py-3 rounded-full mt-10 text-sm cursor-pointer hover:translate-y-[-2px] transition-all duration-500'>More</button>
        </div>
    )
}
