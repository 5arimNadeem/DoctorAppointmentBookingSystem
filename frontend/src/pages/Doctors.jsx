...
const Doctors = () => {
  ...
  return (
    <div>
      <p className='text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium explicabo sint excepturi.</p>
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        <div className="w-full grid grid-cols-[1fr_1fr_1fr_1fr_1fr] gap-4 gap-y-5">
          {
