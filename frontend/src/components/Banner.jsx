    ...
    <div className='flex bg-primary px-6 rounded-lg sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
      ...
      <div className="flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5">
        ...
        <button
          ...
          className='bg-white text-gray-600 px-12 py-3 rounded-full mt-10 text-sm  cursor-pointer hover:translate-y-[-5px] transition-all duration-500'>Create Account</button>
      </div>
